...
系统设计这个面试环节，首先当然是考察候选人的对<strong>系统(System)</strong>底层的了解，然后考察的是候选人的<strong>架构(Architect)</strong>能力，在各种工具和方案中组合出最合适的。最后，大部分系统设计题是开放型的题目，这时候<strong>沟通(Communication)</strong>很重要，要多问面试官，理解题意，给出一个能自圆其说的结论。
